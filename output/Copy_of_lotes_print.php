...
$layout->blocks["top"][] = "pdf";$page_layouts["Copy_of_lotes_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "codigo_insumo";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("codigo_insumo");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "proveedor";
...
//	codigo_insumo - 
			$record["codigo_insumo_value"] = $pageObject->showDBValue("codigo_insumo", $data, $keylink);
			$record["codigo_insumo_class"] = $pageObject->fieldClass("codigo_insumo");
//	proveedor - 
...
$xt->assign("codigo_insumo_fieldheadercolumn",true);
$xt->assign("codigo_insumo_fieldheader",true);
$xt->assign("codigo_insumo_fieldcolumn",true);
$xt->assign("codigo_insumo_fieldfootercolumn",true);
