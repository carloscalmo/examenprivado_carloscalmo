...
$layout->blocks["top"][] = "details";$page_layouts["servicio_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='servicio_edit.php?".$editlink."'\"");
