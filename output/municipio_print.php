...
$layout->blocks["top"][] = "pdf";$page_layouts["municipio_print"] = $layout;
...
//	departamento - 
			$record["departamento_value"] = $pageObject->showDBValue("departamento", $data, $keylink);
			$record["departamento_class"] = $pageObject->fieldClass("departamento");
			if($col<$colsonpage)
...
if($mastertable == "departamento")
{
//	include proper masterprint.php code
	include("include/departamento_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"municipio","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_departamento";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["departamento_masterprint"] = $layout;

	$layout = GetPageLayout("departamento", 'masterprint');
	if($layout)
	{
...
$xt->assign("departamento_fieldheadercolumn",true);
$xt->assign("departamento_fieldheader",true);
$xt->assign("departamento_fieldcolumn",true);
$xt->assign("departamento_fieldfootercolumn",true);
