...
function GetTableURL($table = "")
{
	...
	if("servicio" == $table) 
		return "servicio";
	if("detalle_servicio" == $table) 
		return "detalle_servicio";
	if("usuarios" == $table) 
		return "usuarios";
	if("abonos_clientes" == $table) 
		return "abonos_clientes";
	if("abonos_proveedores" == $table) 
		return "abonos_proveedores";
	if("tipo_ambiente" == $table) 
		return "tipo_ambiente";
	if("cirugia" == $table) 
		return "cirugia";
	if("consulta" == $table) 
		return "consulta";
	if("descarga_inventario_expirado" == $table) 
		return "descarga_inventario_expirado";
	if("detalle_cirugia" == $table) 
		return "detalle_cirugia";
	if("detalle_compra" == $table) 
		return "detalle_compra";
	if("diagnostico" == $table) 
		return "diagnostico";
	if("empleado" == $table) 
		return "empleado";
	if("empleados_cirugia" == $table) 
		return "empleados_cirugia";
	if("factura_compra" == $table) 
		return "factura_compra";
	if("hospitalizacion" == $table) 
		return "hospitalizacion";
	if("proveedores" == $table) 
		return "proveedores";
	if("persona" == $table) 
		return "persona";
	if("puesto" == $table) 
		return "puesto";
	if("solicitud_servicio" == $table) 
		return "solicitud_servicio";
	if("tipo_cirugia" == $table) 
		return "tipo_cirugia";
	if("tipo_consulta" == $table) 
		return "tipo_consulta";
	if("ambiente" == $table) 
		return "ambiente";
	if("cobro_consulta" == $table) 
		return "cobro_consulta";
	if("cobro_insumos" == $table) 
		return "cobro_insumos";
	if("cobro_servicios" == $table) 
		return "cobro_servicios";
	if("cobro_hospitalizacion" == $table) 
		return "cobro_hospitalizacion";
	if("cobro_cirugia" == $table) 
		return "cobro_cirugia";
	if("total_factura" == $table) 
		return "total_factura";
	if("lotes" == $table) 
		return "lotes";
	if("Copy of empleado" == $table) 
		return "Copy_of_empleado";
	if("factura_consulta" == $table) 
		return "factura_consulta";
	if("Copy of departamento" == $table) 
		return "Copy_of_departamento";
	if("municipio_departamento" == $table) 
		return "municipio_departamento";
	if("genero" == $table) 
		return "genero";
	if("Copy of factura_compra" == $table) 
		return "Copy_of_factura_compra";
	if("Copy of factura_compra1" == $table) 
		return "Copy_of_factura_compra1";
	if("Copy of insumos" == $table) 
		return "Copy_of_insumos";
	if("Copy of insumos1" == $table) 
		return "Copy_of_insumos1";
	if("Copy of cirugia" == $table) 
		return "Copy_of_cirugia";
	if("Copy of consulta" == $table) 
		return "Copy_of_consulta";
	...
	if("admin_users" == $table) 
		return "admin_users";
	if("Estado de cuenta de los pacientes" == $table) 
		return "Estado_de_cuenta_de_los_pacientes";
	if("Historial de compras" == $table) 
		return "Historial_de_compras";
	if("Historial de ventas" == $table) 
		return "Historial_de_ventas";
	if("solicitud_medicamento" == $table) 
		return "solicitud_medicamento";
	if("Copy of lotes" == $table) 
		return "Copy_of_lotes";
	if("Producto_Caducados" == $table) 
		return "Producto_Caducados";
}
...
{	
	...
	if("municipio" == $shortTName) 
		return "municipio";
	if("insumos" == $shortTName) 
		return "insumos";
	if("servicio" == $shortTName) 
		return "servicio";
	if("detalle_servicio" == $shortTName) 
		return "detalle_servicio";
	if("usuarios" == $shortTName) 
		return "usuarios";
	if("abonos_clientes" == $shortTName) 
		return "abonos_clientes";
	if("abonos_proveedores" == $shortTName) 
		return "abonos_proveedores";
	if("tipo_ambiente" == $shortTName) 
		return "tipo_ambiente";
	if("cirugia" == $shortTName) 
		return "cirugia";
	if("consulta" == $shortTName) 
		return "consulta";
	if("descarga_inventario_expirado" == $shortTName) 
		return "descarga_inventario_expirado";
	if("detalle_cirugia" == $shortTName) 
		return "detalle_cirugia";
	if("detalle_compra" == $shortTName) 
		return "detalle_compra";
	if("diagnostico" == $shortTName) 
		return "diagnostico";
	if("empleado" == $shortTName) 
		return "empleado";
	if("empleados_cirugia" == $shortTName) 
		return "empleados_cirugia";
	if("factura_compra" == $shortTName) 
		return "factura_compra";
	if("hospitalizacion" == $shortTName) 
		return "hospitalizacion";
	if("proveedores" == $shortTName) 
		return "proveedores";
	if("persona" == $shortTName) 
		return "persona";
	if("puesto" == $shortTName) 
		return "puesto";
	if("solicitud_servicio" == $shortTName) 
		return "solicitud_servicio";
	if("tipo_cirugia" == $shortTName) 
		return "tipo_cirugia";
	if("tipo_consulta" == $shortTName) 
		return "tipo_consulta";
	if("ambiente" == $shortTName) 
		return "ambiente";
	if("cobro_consulta" == $shortTName) 
		return "cobro_consulta";
	if("cobro_insumos" == $shortTName) 
		return "cobro_insumos";
	if("cobro_servicios" == $shortTName) 
		return "cobro_servicios";
	if("cobro_hospitalizacion" == $shortTName) 
		return "cobro_hospitalizacion";
	if("cobro_cirugia" == $shortTName) 
		return "cobro_cirugia";
	if("total_factura" == $shortTName) 
		return "total_factura";
	if("lotes" == $shortTName) 
		return "lotes";
	if("Copy_of_empleado" == $shortTName) 
		return "Copy of empleado";
	if("factura_consulta" == $shortTName) 
		return "factura_consulta";
	if("Copy_of_departamento" == $shortTName) 
		return "Copy of departamento";
	if("municipio_departamento" == $shortTName) 
		return "municipio_departamento";
	if("genero" == $shortTName) 
		return "genero";
	if("Copy_of_factura_compra" == $shortTName) 
		return "Copy of factura_compra";
	if("Copy_of_factura_compra1" == $shortTName) 
		return "Copy of factura_compra1";
	if("Copy_of_insumos" == $shortTName) 
		return "Copy of insumos";
	if("Copy_of_insumos1" == $shortTName) 
		return "Copy of insumos1";
	if("Copy_of_cirugia" == $shortTName) 
		return "Copy of cirugia";
	if("Copy_of_consulta" == $shortTName) 
		return "Copy of consulta";
	...
	if("admin_users" == $shortTName) 
		return "admin_users";
	if("Estado_de_cuenta_de_los_pacientes" == $shortTName) 
		return "Estado de cuenta de los pacientes";
	if("Historial_de_compras" == $shortTName) 
		return "Historial de compras";
	if("Historial_de_ventas" == $shortTName) 
		return "Historial de ventas";
	if("solicitud_medicamento" == $shortTName) 
		return "solicitud_medicamento";
	if("Copy_of_lotes" == $shortTName) 
		return "Copy of lotes";
	if("Producto_Caducados" == $shortTName) 
		return "Producto_Caducados";
}
