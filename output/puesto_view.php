...
$layout->blocks["top"][] = "details";$page_layouts["puesto_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='puesto_edit.php?".$editlink."'\"");
