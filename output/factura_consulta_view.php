...
$layout->blocks["top"][] = "details";$page_layouts["factura_consulta_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cliente_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("cliente_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "fecha";
...
//numero_factura - 
	...
	if($mainTableOwnerID=="numero_factura")
		$ownerIdValue=$value;
	$xt->assign("numero_factura_value",$value);
...
//cliente_id - 
	...
	if($mainTableOwnerID=="cliente_id")
		$ownerIdValue=$value;
	$xt->assign("cliente_id_value",$value);
...
//monto - Number
	...
	if($mainTableOwnerID=="monto")
		$ownerIdValue=$value;
	$xt->assign("monto_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='factura_consulta_edit.php?".$editlink."'\"");
