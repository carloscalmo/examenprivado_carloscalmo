...
$layout->blocks["top"][] = "details";$page_layouts["Copy_of_departamento_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "departamento";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("departamento");
$fieldsArr[] = $arr;
...
//nombre1 - 
	...
	if($mainTableOwnerID=="nombre1")
		$ownerIdValue=$value;
	$xt->assign("nombre1_value",$value);
	if(!$pageObject->isAppearOnTabs("nombre1"))
		$xt->assign("nombre1_fieldblock",true);
	else
		$xt->assign("nombre1_tabfieldblock",true);
////////////////////////////////////////////
//departamento - 
	
	$value = $pageObject->showDBValue("departamento", $data, $keylink);
	if($mainTableOwnerID=="departamento")
		$ownerIdValue=$value;
	$xt->assign("departamento_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Copy_of_departamento_edit.php?".$editlink."'\"");
