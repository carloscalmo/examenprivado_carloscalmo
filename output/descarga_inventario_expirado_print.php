...
$layout->blocks["top"][] = "pdf";$page_layouts["descarga_inventario_expirado_print"] = $layout;
...
$arr = array();
$arr['fName'] = "lotes";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("lotes");
$fieldsArr[] = $arr;
$arr = array();
...
//	lotes - 
			$record["lotes_value"] = $pageObject->showDBValue("lotes", $data, $keylink);
			$record["lotes_class"] = $pageObject->fieldClass("lotes");
//	fecha - Short Date
			$record["fecha_value"] = $pageObject->showDBValue("fecha", $data, $keylink);
			$record["fecha_class"] = $pageObject->fieldClass("fecha");
//	responsable - 
			$record["responsable_value"] = $pageObject->showDBValue("responsable", $data, $keylink);
			$record["responsable_class"] = $pageObject->fieldClass("responsable");
			if($col<$colsonpage)
...
if($mastertable == "usuarios")
{
//	include proper masterprint.php code
	include("include/usuarios_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"descarga_inventario_expirado","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_usuarios";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["usuarios_masterprint"] = $layout;
	...
	$layout = GetPageLayout("usuarios", 'masterprint');
	if($layout)
	{
...
$xt->assign("lotes_fieldheadercolumn",true);
$xt->assign("lotes_fieldheader",true);
$xt->assign("lotes_fieldcolumn",true);
$xt->assign("lotes_fieldfootercolumn",true);
...
$xt->assign("responsable_fieldheadercolumn",true);
$xt->assign("responsable_fieldheader",true);
$xt->assign("responsable_fieldcolumn",true);
$xt->assign("responsable_fieldfootercolumn",true);
