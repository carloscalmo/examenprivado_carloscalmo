...
$layout->blocks["top"][] = "details";$page_layouts["Copy_of_factura_compra1_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Copy_of_factura_compra1_edit.php?".$editlink."'\"");
