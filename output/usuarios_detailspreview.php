...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["usuarios_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	contraseña - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("contraseña", $data, $keylink);
			$row["contrase_a_value"] = $value;
	//	fecha_inicio - Short Date
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("fecha_inicio", $data, $keylink);
			$row["fecha_inicio_value"] = $value;
	//	fecha_fin - Short Date
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("fecha_fin", $data, $keylink);
			$row["fecha_fin_value"] = $value;
	//	baja - Checkbox
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("baja", $data, $keylink);
			$row["baja_value"] = $value;
	//	empleado_id - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("usuarios_detailspreview.htm");
