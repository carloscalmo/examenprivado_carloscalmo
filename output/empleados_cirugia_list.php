...
$layout->blocks["top"][] = "toplinks";$page_layouts["empleados_cirugia_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("cirugia", PAGE_LIST), PAGE_LIST);
