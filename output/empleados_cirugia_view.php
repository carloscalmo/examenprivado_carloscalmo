...
$layout->blocks["top"][] = "details";$page_layouts["empleados_cirugia_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cirugia_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("cirugia_id");
$fieldsArr[] = $arr;
...
//cirugia_id - 
	...
	if($mainTableOwnerID=="cirugia_id")
		$ownerIdValue=$value;
	$xt->assign("cirugia_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='empleados_cirugia_edit.php?".$editlink."'\"");
