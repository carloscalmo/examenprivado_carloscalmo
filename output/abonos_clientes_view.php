...
$layout->blocks["top"][] = "details";$page_layouts["abonos_clientes_view"] = $layout;
...
//factura_servicio_id - 
	...
	if($mainTableOwnerID=="factura_servicio_id")
		$ownerIdValue=$value;
	$xt->assign("factura_servicio_id_value",$value);
...
//observaciones - 
	...
	if($mainTableOwnerID=="observaciones")
		$ownerIdValue=$value;
	$xt->assign("observaciones_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='abonos_clientes_edit.php?".$editlink."'\"");
