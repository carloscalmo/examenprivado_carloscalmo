...
$layout->blocks["top"][] = "pdf";$page_layouts["factura_consulta_print"] = $layout;
...
//	cliente_id - 
			$record["cliente_id_value"] = $pageObject->showDBValue("cliente_id", $data, $keylink);
			$record["cliente_id_class"] = $pageObject->fieldClass("cliente_id");
//	fecha - Short Date
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"factura_consulta","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("cliente_id_fieldheadercolumn",true);
$xt->assign("cliente_id_fieldheader",true);
$xt->assign("cliente_id_fieldcolumn",true);
$xt->assign("cliente_id_fieldfootercolumn",true);
