...
$layout->blocks["top"][] = "toplinks";$page_layouts["abonos_clientes_list"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["factura_consulta_masterlist"] = $layout;

$layout = GetPageLayout("factura_consulta", 'masterlist');
if($layout)
{
...
$viewControls = new ViewControlsContainer(new ProjectSettings("factura_consulta", PAGE_LIST), PAGE_LIST);
