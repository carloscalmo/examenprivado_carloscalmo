...
$layout->blocks["top"][] = "details";$page_layouts["descarga_inventario_expirado_view"] = $layout;
...
//lotes - 
	...
	if($mainTableOwnerID=="lotes")
		$ownerIdValue=$value;
	$xt->assign("lotes_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='descarga_inventario_expirado_edit.php?".$editlink."'\"");
