...
$layout->blocks["top"][] = "details";$page_layouts["usuarios_view"] = $layout;
...
//Rol - 
	...
	if($mainTableOwnerID=="Rol")
		$ownerIdValue=$value;
	$xt->assign("Rol_value",$value);
...
//contraseña - 
	...
	if($mainTableOwnerID=="contraseña")
		$ownerIdValue=$value;
	$xt->assign("contrase_a_value",$value);
...
//empleado_id - 
	...
	if($mainTableOwnerID=="empleado_id")
		$ownerIdValue=$value;
	$xt->assign("empleado_id_value",$value);
...
//fecha_inicio - Short Date
	...
	if($mainTableOwnerID=="fecha_inicio")
		$ownerIdValue=$value;
	$xt->assign("fecha_inicio_value",$value);
...
//fecha_fin - Short Date
	...
	if($mainTableOwnerID=="fecha_fin")
		$ownerIdValue=$value;
	$xt->assign("fecha_fin_value",$value);
...
//baja - Checkbox
	...
	if($mainTableOwnerID=="baja")
		$ownerIdValue=$value;
	$xt->assign("baja_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='usuarios_edit.php?".$editlink."'\"");
