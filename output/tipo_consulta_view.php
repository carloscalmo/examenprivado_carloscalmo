...
$layout->blocks["top"][] = "details";$page_layouts["tipo_consulta_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tipo_consulta_edit.php?".$editlink."'\"");
