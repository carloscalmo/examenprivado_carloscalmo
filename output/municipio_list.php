...
include_once("include/proveedores_settings.php");
include_once("include/persona_settings.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["municipio_list"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["departamento_masterlist"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("departamento", PAGE_LIST), PAGE_LIST);
