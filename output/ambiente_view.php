...
$layout->blocks["top"][] = "details";$page_layouts["ambiente_view"] = $layout;
...
$arr = array();
$arr['fName'] = "capacidad";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("capacidad");
$fieldsArr[] = $arr;
$arr = array();
...
//capacidad - 
	...
	if($mainTableOwnerID=="capacidad")
		$ownerIdValue=$value;
	$xt->assign("capacidad_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ambiente_edit.php?".$editlink."'\"");
