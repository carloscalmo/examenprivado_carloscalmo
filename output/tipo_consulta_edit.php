...
$layout->blocks["top"][] = "details";$page_layouts["tipo_consulta_edit"] = $layout;
...
$templatefile = "tipo_consulta_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: tipo_consulta_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: tipo_consulta_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='tipo_consulta_view.php?".$viewlink."'\"");
