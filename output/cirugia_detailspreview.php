...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["cirugia_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("encargado", $strTableName, false)."=".make_db_value("encargado",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	encargado - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("encargado", $data, $keylink);
			$row["encargado_value"] = $value;
	//	ambiente_id - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("cirugia_detailspreview.htm");
