...
$layout->blocks["top"][] = "details";$page_layouts["Copy_of_lotes_view"] = $layout;
...
//produccion - Short Date
	...
	if($mainTableOwnerID=="produccion")
		$ownerIdValue=$value;
	$xt->assign("produccion_value",$value);
...
//caducidad - Short Date
	...
	if($mainTableOwnerID=="caducidad")
		$ownerIdValue=$value;
	$xt->assign("caducidad_value",$value);
...
//expirado - Checkbox
	...
	if($mainTableOwnerID=="expirado")
		$ownerIdValue=$value;
	$xt->assign("expirado_value",$value);
...
//precio - Number
	...
	if($mainTableOwnerID=="precio")
		$ownerIdValue=$value;
	$xt->assign("precio_value",$value);
...
//costo - Number
	...
	if($mainTableOwnerID=="costo")
		$ownerIdValue=$value;
	$xt->assign("costo_value",$value);
...
//codigo_insumo - 
	...
	if($mainTableOwnerID=="codigo_insumo")
		$ownerIdValue=$value;
	$xt->assign("codigo_insumo_value",$value);
	if(!$pageObject->isAppearOnTabs("codigo_insumo"))
		$xt->assign("codigo_insumo_fieldblock",true);
	else
		$xt->assign("codigo_insumo_tabfieldblock",true);
////////////////////////////////////////////
//proveedor - 
	
	$value = $pageObject->showDBValue("proveedor", $data, $keylink);
	if($mainTableOwnerID=="proveedor")
		$ownerIdValue=$value;
	$xt->assign("proveedor_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Copy_of_lotes_edit.php?".$editlink."'\"");
