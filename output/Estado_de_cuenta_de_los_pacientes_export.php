...
$layout->blocks["top"][] = "export";$page_layouts["Estado_de_cuenta_de_los_pacientes_export"] = $layout;
...
$xt->display("Estado_de_cuenta_de_los_pacientes_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Estado_de_cuenta_de_los_pacientes.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Estado_de_cuenta_de_los_pacientes.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Estado_de_cuenta_de_los_pacientes.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Estado_de_cuenta_de_los_pacientes.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Fecha de consulta").'</td>';	
