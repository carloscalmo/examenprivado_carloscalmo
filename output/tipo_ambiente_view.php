...
$layout->blocks["top"][] = "details";$page_layouts["tipo_ambiente_view"] = $layout;
...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "idtipo_ambiente";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("idtipo_ambiente");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nombre";
...
//idtipo_ambiente - 
	...
	if($mainTableOwnerID=="idtipo_ambiente")
		$ownerIdValue=$value;
	$xt->assign("idtipo_ambiente_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tipo_ambiente_edit.php?".$editlink."'\"");
