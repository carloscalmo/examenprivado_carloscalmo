...
$layout->blocks["top"][] = "details";$page_layouts["factura_compra_view"] = $layout;
...
//total_factura - Number
	...
	if($mainTableOwnerID=="total_factura")
		$ownerIdValue=$value;
	$xt->assign("total_factura_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='factura_compra_edit.php?".$editlink."'\"");
