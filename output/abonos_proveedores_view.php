...
$layout->blocks["top"][] = "details";$page_layouts["abonos_proveedores_view"] = $layout;
...
//factura - 
	...
	if($mainTableOwnerID=="factura")
		$ownerIdValue=$value;
	$xt->assign("factura_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='abonos_proveedores_edit.php?".$editlink."'\"");
