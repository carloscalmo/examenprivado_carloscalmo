...
include_once("include/abonos_proveedores_settings.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["factura_compra_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "numero_factura";
			}
