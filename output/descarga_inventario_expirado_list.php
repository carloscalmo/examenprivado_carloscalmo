...
$layout->blocks["top"][] = "toplinks";$page_layouts["descarga_inventario_expirado_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("usuarios", PAGE_LIST), PAGE_LIST);
