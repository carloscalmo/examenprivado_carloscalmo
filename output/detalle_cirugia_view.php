...
$layout->blocks["top"][] = "details";$page_layouts["detalle_cirugia_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "insumos_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("insumos_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cantidad";
...
//insumos_id - 
	...
	if($mainTableOwnerID=="insumos_id")
		$ownerIdValue=$value;
	$xt->assign("insumos_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='detalle_cirugia_edit.php?".$editlink."'\"");
