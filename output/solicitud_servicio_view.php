...
$layout->blocks["top"][] = "details";$page_layouts["solicitud_servicio_view"] = $layout;
...
//servicio_id - 
	...
	if($mainTableOwnerID=="servicio_id")
		$ownerIdValue=$value;
	$xt->assign("servicio_id_value",$value);
...
//solicitante - 
	...
	if($mainTableOwnerID=="solicitante")
		$ownerIdValue=$value;
	$xt->assign("solicitante_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='solicitud_servicio_edit.php?".$editlink."'\"");
