...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["factura_compra_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	numero_factura - 
		    ...
		    $value = $viewContainer->showDBValue("numero_factura", $data, $keylink);
			$row["numero_factura_value"] = $value;
	//	fecha - Short Date
			$viewContainer->recId = $recordsCounter;
	...
	//	total_factura - Number
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("total_factura", $data, $keylink);
			$row["total_factura_value"] = $value;
	//	proveedor - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("factura_compra_detailspreview.htm");
