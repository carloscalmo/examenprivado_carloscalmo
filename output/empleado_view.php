...
$layout->blocks["top"][] = "details";$page_layouts["empleado_view"] = $layout;
...
//persona_id - 
	...
	if($mainTableOwnerID=="persona_id")
		$ownerIdValue=$value;
	$xt->assign("persona_id_value",$value);
...
//profesion - 
	...
	if($mainTableOwnerID=="profesion")
		$ownerIdValue=$value;
	$xt->assign("profesion_value",$value);
...
//puesto_id - 
	...
	if($mainTableOwnerID=="puesto_id")
		$ownerIdValue=$value;
	$xt->assign("puesto_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='empleado_edit.php?".$editlink."'\"");
