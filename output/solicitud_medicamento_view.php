...
$layout->blocks["top"][] = "details";$page_layouts["solicitud_medicamento_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "responsable";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("responsable");
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "lote_id";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("lote_id");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "cantidad";
...
//responsable - 
	...
	if($mainTableOwnerID=="responsable")
		$ownerIdValue=$value;
	$xt->assign("responsable_value",$value);
...
//medicamento_id - 
	...
	if($mainTableOwnerID=="medicamento_id")
		$ownerIdValue=$value;
	$xt->assign("medicamento_id_value",$value);
...
//lote_id - 
	...
	if($mainTableOwnerID=="lote_id")
		$ownerIdValue=$value;
	$xt->assign("lote_id_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='solicitud_medicamento_edit.php?".$editlink."'\"");
