...
add_nocache_headers();
include("include/servicio_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["servicio_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "servicio_inline_add.htm";
else
	$templatefile = "servicio_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: servicio_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'servicio_edit.php?'.$keylink.'\'>'."Editar".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'servicio_view.php?'.$keylink.'\'>'."Ver".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: servicio_".$pageObject->getPageType().".php");
