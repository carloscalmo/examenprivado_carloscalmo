...
$layout->blocks["top"][] = "details";$page_layouts["diagnostico_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='diagnostico_edit.php?".$editlink."'\"");
