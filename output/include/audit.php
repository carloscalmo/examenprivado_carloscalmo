...
{
	var $logTableName="prueba2_audit";
	var $TableObj;
	var $params;
	...
	function logValueEnable($table)
	{
		...
		if($table=="abonos_clientes")
		{
			return true;
		}
		if($table=="abonos_proveedores")
		{
			return true;
		}
		if($table=="tipo_ambiente")
		{
			return true;
		}
		if($table=="cirugia")
		...
		if($table=="descarga_inventario_expirado")
		{
			return true;
		}
		if($table=="detalle_cirugia")
		{
			return true;
		}
		...
		if($table=="empleados_cirugia")
		{
			return true;
		}
		if($table=="factura_compra")
		{
			return true;
		}
		if($table=="hospitalizacion")
		{
			return true;
		}
		...
		if($table=="solicitud_servicio")
		{
			return true;
		}
		if($table=="tipo_cirugia")
		{
			return true;
		}
		if($table=="tipo_consulta")
		{
			return true;
		}
		if($table=="ambiente")
		...
		if($table=="cobro_consulta")
		{
			return false;
		}
		if($table=="cobro_insumos")
		{
			return false;
		}
		if($table=="cobro_servicios")
		{
			return false;
		}
		if($table=="cobro_hospitalizacion")
		{
			return false;
		}
		if($table=="cobro_cirugia")
		{
			return false;
		}
		if($table=="total_factura")
		{
			return false;
		}
		if($table=="lotes")
		...
		if($table=="Copy of empleado")
		{
			return false;
		}
		if($table=="factura_consulta")
		{
			return false;
		}
		if($table=="Copy of departamento")
		{
			return false;
		}
		if($table=="municipio_departamento")
		{
			return false;
		}
		if($table=="genero")
		...
		if($table=="Copy of factura_compra")
		{
			return false;
		}
		if($table=="Copy of factura_compra1")
		{
			return false;
		}
		if($table=="Copy of insumos")
		{
			return false;
		}
		if($table=="Copy of insumos1")
		{
			return false;
		}
		if($table=="Copy of cirugia")
		{
			return false;
		}
		if($table=="Copy of consulta")
		{
			return false;
		}
		...
		if($table=="Estado de cuenta de los pacientes")
		{
			return true;
		}
		if($table=="Historial de compras")
		{
			return true;
		}
		if($table=="Historial de ventas")
		{
			return true;
		}
		if($table=="solicitud_medicamento")
		{
			return false;
		}
		if($table=="Copy of lotes")
		{
			return false;
		}
		if($table=="Producto_Caducados")
		{
			return true;
		}
	}
