<?php
include_once(getabspath("include/tipo_consulta_settings.php"));

function DisplayMasterTableInfo_tipo_consulta($params)
{
...
//$strSQL = "SELECT id,   nombre,   precio  FROM tipo_consulta ";
...
//	precio - Number
	...
	$xt->display("tipo_consulta_masterprint.htm");
	$strTableName=$oldTableName;
