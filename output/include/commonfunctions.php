...
function checkTableName($shortTName, $type=false)
{
	...
	if ("departamento" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("municipio" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("insumos" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("servicio" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("detalle_servicio" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("usuarios" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("abonos_clientes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("abonos_proveedores" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tipo_ambiente" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("cirugia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("consulta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("descarga_inventario_expirado" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("detalle_cirugia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("detalle_compra" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("diagnostico" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("empleado" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("empleados_cirugia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("factura_compra" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("hospitalizacion" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("proveedores" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("persona" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("puesto" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("solicitud_servicio" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tipo_cirugia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tipo_consulta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ambiente" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("cobro_consulta" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("cobro_insumos" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("cobro_servicios" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("cobro_hospitalizacion" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("cobro_cirugia" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("total_factura" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("lotes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Copy_of_empleado" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("factura_consulta" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Copy_of_departamento" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("municipio_departamento" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("genero" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Copy_of_factura_compra" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_factura_compra1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_insumos" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_insumos1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_cirugia" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Copy_of_consulta" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	...
	if ("admin_users" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Estado_de_cuenta_de_los_pacientes" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Historial_de_compras" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Historial_de_ventas" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("solicitud_medicamento" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Copy_of_lotes" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("Producto_Caducados" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("insumos");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="insumos";
	}
	$strPerm = GetUserPermissions("servicio");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="servicio";
	}
	$strPerm = GetUserPermissions("detalle_servicio");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="detalle_servicio";
	}
	...
	$strPerm = GetUserPermissions("abonos_clientes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="abonos_clientes";
	}
	$strPerm = GetUserPermissions("abonos_proveedores");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="abonos_proveedores";
	}
	$strPerm = GetUserPermissions("tipo_ambiente");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="tipo_ambiente";
	}
	$strPerm = GetUserPermissions("cirugia");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cirugia";
	}
	$strPerm = GetUserPermissions("consulta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="consulta";
	}
	$strPerm = GetUserPermissions("descarga_inventario_expirado");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="descarga_inventario_expirado";
	}
	$strPerm = GetUserPermissions("detalle_cirugia");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="detalle_cirugia";
	}
	$strPerm = GetUserPermissions("detalle_compra");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="detalle_compra";
	}
	$strPerm = GetUserPermissions("diagnostico");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="diagnostico";
	}
	$strPerm = GetUserPermissions("empleado");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="empleado";
	}
	$strPerm = GetUserPermissions("empleados_cirugia");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="empleados_cirugia";
	}
	$strPerm = GetUserPermissions("factura_compra");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="factura_compra";
	}
	$strPerm = GetUserPermissions("hospitalizacion");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="hospitalizacion";
	}
	$strPerm = GetUserPermissions("proveedores");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="proveedores";
	}
	$strPerm = GetUserPermissions("persona");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="persona";
	}
	$strPerm = GetUserPermissions("puesto");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="puesto";
	}
	$strPerm = GetUserPermissions("solicitud_servicio");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="solicitud_servicio";
	}
	$strPerm = GetUserPermissions("tipo_cirugia");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="tipo_cirugia";
	}
	$strPerm = GetUserPermissions("tipo_consulta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="tipo_consulta";
	}
	$strPerm = GetUserPermissions("ambiente");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ambiente";
	}
	$strPerm = GetUserPermissions("cobro_consulta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cobro_consulta";
	}
	$strPerm = GetUserPermissions("cobro_insumos");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cobro_insumos";
	}
	$strPerm = GetUserPermissions("cobro_servicios");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cobro_servicios";
	}
	$strPerm = GetUserPermissions("cobro_hospitalizacion");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cobro_hospitalizacion";
	}
	$strPerm = GetUserPermissions("cobro_cirugia");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="cobro_cirugia";
	}
	$strPerm = GetUserPermissions("total_factura");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="total_factura";
	}
	$strPerm = GetUserPermissions("lotes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lotes";
	}
	$strPerm = GetUserPermissions("Copy of empleado");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of empleado";
	}
	$strPerm = GetUserPermissions("factura_consulta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="factura_consulta";
	}
	$strPerm = GetUserPermissions("Copy of departamento");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of departamento";
	}
	$strPerm = GetUserPermissions("municipio_departamento");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="municipio_departamento";
	}
	$strPerm = GetUserPermissions("genero");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="genero";
	}
	$strPerm = GetUserPermissions("Copy of factura_compra");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of factura_compra";
	}
	$strPerm = GetUserPermissions("Copy of factura_compra1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of factura_compra1";
	}
	$strPerm = GetUserPermissions("Copy of insumos");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of insumos";
	}
	$strPerm = GetUserPermissions("Copy of insumos1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of insumos1";
	}
	$strPerm = GetUserPermissions("Copy of cirugia");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of cirugia";
	}
	$strPerm = GetUserPermissions("Copy of consulta");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of consulta";
	}
	...
	$strPerm = GetUserPermissions("Estado de cuenta de los pacientes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Estado de cuenta de los pacientes";
	}
	$strPerm = GetUserPermissions("Historial de compras");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Historial de compras";
	}
	$strPerm = GetUserPermissions("Historial de ventas");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Historial de ventas";
	}
	$strPerm = GetUserPermissions("solicitud_medicamento");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="solicitud_medicamento";
	}
	$strPerm = GetUserPermissions("Copy of lotes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Copy of lotes";
	}
	$strPerm = GetUserPermissions("Producto_Caducados");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Producto_Caducados";
	}
	return $arr;
}
...
function ReadUserPermissions($userID="")
{
	...
	if($userID!="Guest")
	{
			...
			$sql = "select `GroupID`, `UserName` from `permisosugmembers` where `UserName`=".db_prepare_string($userID);
		else
			$sql = "select `GroupID`, `UserName` from `permisosugmembers` where `UserName`=".strtoupper(db_prepare_string($userID));
		$rs = db_query($sql,$conn);
	...
	$rights=array();
	$sql = "select `TableName`,`AccessMask` from `permisosugrights` where `GroupID` in (".$groupstr.")";
	$rs = db_query($sql,$conn);
	while($data=db_fetch_numarray($rs))
	{
...
{	
	...
	if(!count($_SESSION["UserRights"]["Guest"]))
		return false;
	if(array_key_exists("departamento",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("municipio",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("insumos",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("servicio",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("detalle_servicio",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("usuarios",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("abonos_clientes",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("abonos_proveedores",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("tipo_ambiente",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("cirugia",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("consulta",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("descarga_inventario_expirado",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("detalle_cirugia",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("detalle_compra",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("diagnostico",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("empleado",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("empleados_cirugia",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("factura_compra",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("hospitalizacion",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("proveedores",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("persona",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("puesto",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("solicitud_servicio",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("tipo_cirugia",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("tipo_consulta",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("ambiente",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("cobro_consulta",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("cobro_insumos",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("cobro_servicios",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("cobro_hospitalizacion",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("cobro_cirugia",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("total_factura",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lotes",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of empleado",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("factura_consulta",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of departamento",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("municipio_departamento",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("genero",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of factura_compra",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of factura_compra1",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of insumos",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of insumos1",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of cirugia",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of consulta",$_SESSION["UserRights"]["Guest"]))
		return true;
	...
	if(array_key_exists("admin_users",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Estado de cuenta de los pacientes",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Historial de compras",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Historial de ventas",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("solicitud_medicamento",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Copy of lotes",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("Producto_Caducados",$_SESSION["UserRights"]["Guest"]))
		return true;
	return false;
}
...
function inFacebook(){
	...
	if ($signed_request) {
		...
		$strSQL = "select * from ".AddTableWrappers("usuarios")." where ".AddFieldWrappers(GetUserNameField())."='".$strUsername."'";
...
function AfterFBLogIn($pUsername, $pPassword){
	...
	$strSQL = "select * from ".AddTableWrappers("usuarios")." where ".AddFieldWrappers($cUserNameField)."=".$strUsername."";
	$rs = db_query($strSQL,$conn);
 	$data = db_fetch_array($rs);
	if($data){
		$logged=true;
...
{
	global $globalEvents;
		$_SESSION["GroupID"] = $data["id"];


			$_SESSION["OwnerID"] = $data["id"];
		$_SESSION["_usuarios_OwnerID"] = $data["id"];
			$_SESSION["_abonos_clientes_OwnerID"] = $data["id"];
