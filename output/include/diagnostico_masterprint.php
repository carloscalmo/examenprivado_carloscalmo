<?php
include_once(getabspath("include/diagnostico_settings.php"));

function DisplayMasterTableInfo_diagnostico($params)
{
...
//$strSQL = "SELECT id,   nombre,   descripcion  FROM diagnostico ";
...
//	descripcion - 
	...
	$xt->display("diagnostico_masterprint.htm");
	$strTableName=$oldTableName;
