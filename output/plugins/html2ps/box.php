<?php
// $Header: /cvsrepos/html2ps/box.php,v 1.1 2008/07/01 12:30:20 sergey Exp $
...
// XLINEFIX
global $tagprogress,$tagcount,$progressfilename;
$tagprogress++;
if(!($tagprogress%20))
{
	echo '<script>window.parent.Runner.Pdf.SetProgress('.$tagcount.", ".$tagprogress.');</script>';
	if(ob_get_level())
		ob_flush(); 
	flush();
}
