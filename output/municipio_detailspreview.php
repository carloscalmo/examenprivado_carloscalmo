...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["municipio_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("departamento", $strTableName, false)."=".make_db_value("departamento",$_SESSION[$strTableName."_masterkey1"]);
}
...
$xt->load_template("municipio_detailspreview.htm");
