...
$layout->blocks["top"][] = "details";$page_layouts["detalle_servicio_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='detalle_servicio_edit.php?".$editlink."'\"");
