...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["detalle_servicio_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("servicio_id", $strTableName, false)."=".make_db_value("servicio_id",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	servicio_id - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("servicio_id", $data, $keylink);
			$row["servicio_id_value"] = $value;
	//	insumos_id - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("detalle_servicio_detailspreview.htm");
