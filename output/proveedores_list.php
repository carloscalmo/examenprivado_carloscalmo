...
include_once("include/factura_compra_settings.php");
include_once("include/lotes_settings.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["proveedores_list"] = $layout;
