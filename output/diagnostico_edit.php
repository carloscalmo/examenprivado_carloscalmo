...
$layout->blocks["top"][] = "details";$page_layouts["diagnostico_edit"] = $layout;
...
$templatefile = "diagnostico_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: diagnostico_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: diagnostico_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='diagnostico_view.php?".$viewlink."'\"");
