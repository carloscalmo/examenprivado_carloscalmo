...
$layout->blocks["top"][] = "pdf";$page_layouts["Copy_of_consulta_print"] = $layout;
...
$arr = array();
$arr['fName'] = "id1";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("id1");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nombre";
...
//	id1 - 
			$record["id1_value"] = $pageObject->showDBValue("id1", $data, $keylink);
			$record["id1_class"] = $pageObject->fieldClass("id1");
//	nombre - 
...
$xt->assign("id1_fieldheadercolumn",true);
$xt->assign("id1_fieldheader",true);
$xt->assign("id1_fieldcolumn",true);
$xt->assign("id1_fieldfootercolumn",true);
