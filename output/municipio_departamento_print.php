...
$layout->blocks["top"][] = "pdf";$page_layouts["municipio_departamento_print"] = $layout;
...
//	Municipio - 
			$record["Municipio_value"] = $pageObject->showDBValue("Municipio", $data, $keylink);
			$record["Municipio_class"] = $pageObject->fieldClass("Municipio");
			if($col<$colsonpage)
...
$xt->assign("Municipio_fieldheadercolumn",true);
$xt->assign("Municipio_fieldheader",true);
$xt->assign("Municipio_fieldcolumn",true);
$xt->assign("Municipio_fieldfootercolumn",true);
