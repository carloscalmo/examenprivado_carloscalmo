...
$gsqlWhereExpr="";
$gsqlTail="";
// $gstrSQL = "SELECT id,   nombre,   `contraseña`,   fecha_inicio,   fecha_fin,   baja,   empleado_id,   Rol  FROM usuarios ";
...
$layout = new TLayout("ug_members","Rounded1BlueWave","MobileBlueWave");
