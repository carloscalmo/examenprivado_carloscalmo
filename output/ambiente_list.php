...
$layout->blocks["top"][] = "toplinks";$page_layouts["ambiente_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("tipo_ambiente", PAGE_LIST), PAGE_LIST);
