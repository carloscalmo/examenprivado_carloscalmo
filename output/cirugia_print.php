...
$layout->blocks["top"][] = "pdf";$page_layouts["cirugia_print"] = $layout;
...
$arr = array();
$arr['fName'] = "encargado";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("encargado");
$fieldsArr[] = $arr;
$arr = array();
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "idtipo_cirugia";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("idtipo_cirugia");
$fieldsArr[] = $arr;
$arr = array();
...
//	idtipo_cirugia - 
			$record["idtipo_cirugia_value"] = $pageObject->showDBValue("idtipo_cirugia", $data, $keylink);
			$record["idtipo_cirugia_class"] = $pageObject->fieldClass("idtipo_cirugia");
//	consulta_id - 
...
//	encargado - 
			$record["encargado_value"] = $pageObject->showDBValue("encargado", $data, $keylink);
			$record["encargado_class"] = $pageObject->fieldClass("encargado");
//	ambiente_id - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"cirugia","keys"=>$masterkeys);
	$master = array();
...
if($mastertable == "tipo_cirugia")
{
//	include proper masterprint.php code
	include("include/tipo_cirugia_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"cirugia","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_tipo_cirugia";
	$master["params"] = $params;
	$xt->assignbyref("showmasterfile",$master);
	$xt->assign("mastertable_block",true);
	$layout = new TLayout("masterprint","Rounded1BlueWave","MobileBlueWave");
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["tipo_cirugia_masterprint"] = $layout;
	...
	$layout = GetPageLayout("tipo_cirugia", 'masterprint');
	if($layout)
	{
		$rtl = $pageObject->xt->getReadingOrder() == 'RTL' ? 'RTL' : '';
		$xt->cssFiles[] = array("stylepath" => "styles/".$layout->style.'/style'.$rtl.".css"
...
$xt->assign("idtipo_cirugia_fieldheadercolumn",true);
$xt->assign("idtipo_cirugia_fieldheader",true);
$xt->assign("idtipo_cirugia_fieldcolumn",true);
$xt->assign("idtipo_cirugia_fieldfootercolumn",true);
...
$xt->assign("encargado_fieldheadercolumn",true);
$xt->assign("encargado_fieldheader",true);
$xt->assign("encargado_fieldcolumn",true);
$xt->assign("encargado_fieldfootercolumn",true);
