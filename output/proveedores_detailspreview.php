...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["proveedores_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	saldo - Number
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("saldo", $data, $keylink);
			$row["saldo_value"] = $value;
	//	nit - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("proveedores_detailspreview.htm");
