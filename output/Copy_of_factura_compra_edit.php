...
$layout->blocks["top"][] = "details";$page_layouts["Copy_of_factura_compra_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "Copy_of_factura_compra_inline_edit.htm" : "Copy_of_factura_compra_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Copy_of_factura_compra_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: Copy_of_factura_compra_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Copy_of_factura_compra_view.php?".$viewlink."'\"");
