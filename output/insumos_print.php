...
$layout->blocks["top"][] = "pdf";$page_layouts["insumos_print"] = $layout;
...
//	process selection
	if (@$_REQUEST["mdelete"])
	{
		foreach(@$_REQUEST["mdelete"] as $ind)
		{
			...
			$keys["codigo"]=refine($_REQUEST["mdelete2"][mdeleteIndex($ind)]);
			$selected_recs[]=$keys;
		}
	}
...
//	componente - 
			$record["componente_value"] = $pageObject->showDBValue("componente", $data, $keylink);
			$record["componente_class"] = $pageObject->fieldClass("componente");
//	contenido - Number
...
//	presentacion - 
			$record["presentacion_value"] = $pageObject->showDBValue("presentacion", $data, $keylink);
			$record["presentacion_class"] = $pageObject->fieldClass("presentacion");
//	cantidad - Number
...
$xt->assign("componente_fieldheadercolumn",true);
$xt->assign("componente_fieldheader",true);
$xt->assign("componente_fieldcolumn",true);
$xt->assign("componente_fieldfootercolumn",true);
...
$xt->assign("presentacion_fieldheadercolumn",true);
$xt->assign("presentacion_fieldheader",true);
$xt->assign("presentacion_fieldcolumn",true);
$xt->assign("presentacion_fieldfootercolumn",true);
