...
$layout->blocks["top"][] = "pdf";$page_layouts["tipo_cirugia_print"] = $layout;
...
//	process selection
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["idtipo_cirugia"]=refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
	...
	elseif(@$_REQUEST["selection"])
	{
		foreach(@$_REQUEST["selection"] as $keyblock)
		{
			...
			if(count($arr)<2)
				continue;
			$keys=array();
			$keys["idtipo_cirugia"]=urldecode($arr[0]);
