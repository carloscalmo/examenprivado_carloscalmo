...
$layout->blocks["top"][] = "pdf";$page_layouts["solicitud_medicamento_print"] = $layout;
...
//	lote_id - 
			$record["lote_id_value"] = $pageObject->showDBValue("lote_id", $data, $keylink);
			$record["lote_id_class"] = $pageObject->fieldClass("lote_id");
//	cantidad - Number
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"solicitud_medicamento","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("lote_id_fieldheadercolumn",true);
$xt->assign("lote_id_fieldheader",true);
$xt->assign("lote_id_fieldcolumn",true);
$xt->assign("lote_id_fieldfootercolumn",true);
