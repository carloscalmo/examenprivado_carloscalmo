...
$layout->blocks["top"][] = "details";$page_layouts["Copy_of_factura_compra_view"] = $layout;
...
//id1 - 
	...
	if($mainTableOwnerID=="id1")
		$ownerIdValue=$value;
	$xt->assign("id1_value",$value);
	if(!$pageObject->isAppearOnTabs("id1"))
		$xt->assign("id1_fieldblock",true);
	else
		$xt->assign("id1_tabfieldblock",true);
////////////////////////////////////////////
//nombre - 
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Copy_of_factura_compra_edit.php?".$editlink."'\"");
