...
$layout->blocks["top"][] = "pdf";$page_layouts["factura_compra_print"] = $layout;
...
//	process selection
	if (@$_REQUEST["mdelete"])
	{
		foreach(@$_REQUEST["mdelete"] as $ind)
		{
			...
			$keys["numero_factura"]=refine($_REQUEST["mdelete2"][mdeleteIndex($ind)]);
			$selected_recs[]=$keys;
		}
	}
	elseif(@$_REQUEST["selection"])
	{
		foreach(@$_REQUEST["selection"] as $keyblock)
		{
			...
			$keys["numero_factura"]=urldecode($arr[1]);
			$selected_recs[]=$keys;
		}
	}
...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "numero_factura";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("numero_factura");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "fecha";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "total_factura";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("total_factura");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "proveedor";
...
//	numero_factura - 
			$record["numero_factura_value"] = $pageObject->showDBValue("numero_factura", $data, $keylink);
			$record["numero_factura_class"] = $pageObject->fieldClass("numero_factura");
//	proveedor - 
...
//	total_factura - Number
			$record["total_factura_value"] = $pageObject->showDBValue("total_factura", $data, $keylink);
			$record["total_factura_class"] = $pageObject->fieldClass("total_factura");
			if($col<$colsonpage)
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"factura_compra","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("numero_factura_fieldheadercolumn",true);
$xt->assign("numero_factura_fieldheader",true);
$xt->assign("numero_factura_fieldcolumn",true);
$xt->assign("numero_factura_fieldfootercolumn",true);
...
$xt->assign("total_factura_fieldheadercolumn",true);
$xt->assign("total_factura_fieldheader",true);
$xt->assign("total_factura_fieldcolumn",true);
$xt->assign("total_factura_fieldfootercolumn",true);
