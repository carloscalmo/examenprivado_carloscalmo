...
$layout->blocks["top"][] = "details";$page_layouts["cirugia_view"] = $layout;
...
//idtipo_cirugia - 
	...
	if($mainTableOwnerID=="idtipo_cirugia")
		$ownerIdValue=$value;
	$xt->assign("idtipo_cirugia_value",$value);
...
//encargado - 
	...
	if($mainTableOwnerID=="encargado")
		$ownerIdValue=$value;
	$xt->assign("encargado_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='cirugia_edit.php?".$editlink."'\"");
